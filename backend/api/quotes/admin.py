...
class QuoteLineInline(admin.TabularInline):
    ...
    extra = 0
    fields = (
        "line_group", "description", "quantity", "our_cost",
        "margin_pct", "sale_each", "extended", "below_floor_flag",
    )
...
class QuoteAdmin(admin.ModelAdmin):
    list_display = (
        "id", "project", "status", "grand_total",
        "tax_jurisdiction", "approved_by", "approved_at",
    )
...
class QuoteLineAdmin(admin.ModelAdmin):
    list_display = (
        "quote", "line_group", "description", "quantity", "our_cost", "margin_pct",
        "sale_each", "extended", "cost_is_stale", "below_floor_flag",
    )
